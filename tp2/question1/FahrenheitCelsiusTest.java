...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
	...
	public void test_fahrenheitEnCelsius() {
		...
		assertEquals("   80 °F -> 26.6 °C ?", 12.2, question1.FahrenheitCelsius.fahrenheitEnCelsius(54), 0.1);
		assertEquals("   1111 °F -> 599.4 °C ?", 12.2, question1.FahrenheitCelsius.fahrenheitEnCelsius(54), 0.1);
		assertEquals("   10 °F -> -12.2 °C ?", 12.2, question1.FahrenheitCelsius.fahrenheitEnCelsius(54), 0.1);
	}
